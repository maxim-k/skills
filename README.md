...
| [isabl-app](isabl-app/SKILL.md) | Scaffold an Isabl application that wraps a bioinformatics tool, plus a static self-check for faults that otherwise only surface on HPC. |
